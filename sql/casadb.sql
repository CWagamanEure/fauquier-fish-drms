...
--
-- Host: localhost
-- Generation Time: Sep 21, 2026 at 10:32 AM
...
CREATE TABLE `associations` (
  ...
  `filePath` varchar(256) COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `dbevents` (
  ...
  `date` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `startDate` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `endDate` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `startTime` char(5) COLLATE utf8mb4_general_ci DEFAULT '00:00',
  `endTime` char(5) COLLATE utf8mb4_general_ci DEFAULT '00:00',
  `description` text COLLATE utf8mb4_general_ci,
  `completed` text COLLATE utf8mb4_general_ci,
...
(8, 'testingABC', 0.00, NULL, '2025-12-03', '2025-12-08', '12:00', '20:00', 'Play soccer until we get enough money', '0', 'UMW rec field');
...
('blahhTest', 'blahhTest blahhTest', '$2y$10$yREQcPPHx0H1G718yH0M0.UbYshW9oaQGV5PzKfvBu4m0RugnqCQ2', 0),
('HelloWorldTest', 'HelloWorldTest HelloWorldTest', '$2y$10$JgGD1EcJLkTuCjYmDgd2YeGVbbsLd2ghMUZyEGLS5eo/Hac73ooz.', 0),
('testing', 'testing testing', '$2y$10$bvWKCETlc2wkzfMBr8lOG.xfz51gP7kwpV7XJhw7tz.1x4s8qf62.', 0),
('testing2', 'testing2 testing2', '$2y$10$odoklVign3en/jUlmnCYRuwcwmPFw9rORtC/xQaSileSPHkYFFYny', 0),
('testing3', 'testing3 testing3', '$2y$10$Mf27976AkRfGNSznjn0G.Os7ovHgJV5qfAaclsiFTfq1ZYZVEvs/O', 0),
('testing4', 'testing4 testing4', '$2y$10$9R/SeWRi4msH/hFlihYzmOpMPKe9MruxA5r/VQCjkHBH.QC9irWqG', 0),
('testing5', 'testing5 testing5', '$2y$10$vbVjqtVS2Rki8p8rN1ffv.tHi/3gv6Tk8rYTBXz.2GK6zWq.6XPqe', 0),
...
(54.00, 1, '2014, 2015 and 2016 Community Give', '01/01/2015', 0.00, 0, NULL, 1),
...
(1000.00, 188, 'test', '10/29/2025', 0.00, 1, 3, 2),
(100.00, 189, 'test', '10/29/2025', 0.00, 1, 3, 2),
(8989.00, 197, 'Brother May I Have Some Oats', '12/03/2025', 10.00, 1, 3, 2),
(0.00, 198, 'test, woah woah woah', '12/03/2025', 0.00, 0, NULL, 2),
(4.00, 200, NULL, NULL, 0.00, 0, 8, 999);
...
CREATE TABLE `donors` (
  `id` int NOT NULL,
  `first` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `last` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `zip` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(289, 'Add', 'Name', 'here@example.net', '22333', 'Town', 'SK', '233 Highway Blvd', '1235831294.0', 'Genderqueer', 'Added the example!'),
(290, 'Flamebreaker', 'Feljer', 'flame@frozensky.gov', '0', 'Frozen Sky Village', 'NU', '1 Crystal Wing Palace', '19684620572.0', 'Bigender', 'Needs more gilded dragons'),
(291, 'Add', 'Name', 'here@example.net', '22333', 'Town', 'SK', '233 Highway Blvd', '1235831294.0', 'Genderqueer', 'Added the example!'),
(292, 'Flamebreaker', 'Feljer', 'flame@frozensky.gov', '0', 'Frozen Sky Village', 'NU', '1 Crystal Wing Palace', '19684620572.0', 'Bigender', 'Needs more gilded dragons'),
(293, 'Add', 'Name', 'here@example.net', '22333', 'Town', 'SK', '233 Highway Blvd', '1235831294.0', 'Genderqueer', 'Added the example!'),
(294, 'Flamebreaker', 'Feljer', 'flame@frozensky.gov', '0', 'Frozen Sky Village', 'NU', '1 Crystal Wing Palace', '19684620572.0', 'Bigender', 'Needs more gilded dragons'),
(999, 'anonymous', 'anonymous', 'anonymous', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(1000, 'Add', 'Name', 'here@example.net', '22333', 'Town', 'SK', '233 Highway Blvd', '1235831294.0', 'Genderqueer', 'Added the example!'),
(1001, 'Flamebreaker', 'Feljer', 'flame@frozensky.gov', '0', 'Frozen Sky Village', 'NU', '1 Crystal Wing Palace', '19684620572.0', 'Bigender', 'Needs more gilded dragons'),
(1002, 'Add', 'Name', 'here@example.net', '22333', 'Town', 'SK', '233 Highway Blvd', '1235831294.0', 'Genderqueer', 'Added the example!'),
(1003, 'Flamebreaker', 'Feljer', 'flame@frozensky.gov', '0', 'Frozen Sky Village', 'NU', '1 Crystal Wing Palace', '19684620572.0', 'Bigender', 'Needs more gilded dragons'),
(1004, 'testing', 'testing', '', '', '', '', '', '', NULL, '');
...
CREATE TABLE `files` (
  `filePath` varchar(256) COLLATE utf8mb4_general_ci NOT NULL,
  `linkToDrive` varchar(256) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `reports` (
  `id` int NOT NULL,
  `reportType` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dateRangeStart` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dateRangeEnd` char(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `name` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `filePath` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
